...
<head>
    ...
    <title>Mailbox | The Tech Packs</title>
...
<body class="hold-transition sidebar-mini layout-fixed dark-mode layout-footer-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-1">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">{{ session("user")->userFirstName . " " . session("user")->userLastName }}</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/inbox" class="nav-link @yield('inbox')">
                        ...
                        <li class="nav-item">
                            <a href="/sent" class="nav-link @yield('sent')">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="https://thetechpacks.com">The Tech
                    Packs</a>.</strong>
            All rights reserved.
